package bsu.rfe.java.group5.lab4.Shaban.varB5;
...
//                System.out.`println(Arrays.toString(point));
    ...
    private void paintGrid(Graphics2D canvas) {
        ...
        canvas.drawString("", 20, (int) (getHeight() * 0.1));
        canvas.drawString("", 20, (int) (getHeight() * 0.5));
        canvas.drawString("", 20, (int) (getHeight() * 0.9));
    }
